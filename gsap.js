...
window.onload = function() {
        ...
        draggable = Draggable.create(proxy, {
          ...
          onRelease() {
            ...
            dragTimeout = setTimeout(() => {
              gsap.to(tl, { timeScale: -1 }); // Adjust direction
              tl.play();
            }, 1000);
          },
        })[0];
  ...
  // 		: "https://uploads-ssl.webflow.com/666642b50954b5d26bc84836/6667cc65ac473daed3ab8ba3_LogoBlocksMobile.json",
